jQuery(document).ready(function() {
	...
	jQuery("#patterns-server-search #edit-search").addClass("span");
	jQuery("#patterns-server-page-pattern-field").addClass("hero-unit");
	jQuery("#patterns-server-search .form-item-search").addClass("span8");
	jQuery("#patterns-server-search .form-item-selected").addClass("span2");
